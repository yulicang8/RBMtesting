...
Tsum.prototype.useRapunzelPlusSkill = function () {
    var path = [];
   path.push({x: 30, y: 170});

path.push({x: 30, y: 158});

path.push({x: 30, y: 146});

path.push({x: 30, y: 134});

path.push({x: 30, y: 122});

path.push({x: 30, y: 110});
...
path.push({x: 70, y: 108});

path.push({x: 70, y: 120});

path.push({x: 70, y: 132});

path.push({x: 70, y: 144});

path.push({x: 70, y: 156});

path.push({x: 70, y: 168});
path.push({x: 76, y: 170});
path.push({x: 82, y: 170});
path.push({x: 88, y: 170});
path.push({x: 94, y: 170});
path.push({x: 100, y: 170});
path.push({x: 106, y: 170});
path.push({x: 110, y: 170});
path.push({x: 110, y: 164});

path.push({x: 110, y: 152});
path.push({x: 110, y: 146});

path.push({x: 110, y: 134});

path.push({x: 110, y: 122});
path.push({x: 110, y: 116});
path.push({x: 110, y: 110});
path.push({x: 110, y: 104});
path.push({x: 110, y: 98});
path.push({x: 110, y: 92});
path.push({x: 110, y: 86});
path.push({x: 110, y: 80});
path.push({x: 110, y: 74});
path.push({x: 110, y: 68});
path.push({x: 110, y: 62});
path.push({x: 116, y: 60});
path.push({x: 122, y: 60});

path.push({x: 134, y: 60});

path.push({x: 146, y: 60});
path.push({x: 150, y: 60});

path.push({x: 150, y: 72});
path.push({x: 150, y: 78});

path.push({x: 150, y: 90});
path.push({x: 150, y: 96});
path.push({x: 150, y: 102});
path.push({x: 150, y: 108});
path.push({x: 150, y: 114});
path.push({x: 150, y: 120});
path.push({x: 150, y: 126});
path.push({x: 150, y: 132});
path.push({x: 150, y: 138});
path.push({x: 150, y: 144});
path.push({x: 150, y: 150});
path.push({x: 150, y: 156});
path.push({x: 150, y: 162});
path.push({x: 150, y: 168});
    // function addVertical(x, reverse) {
    //     if (!reverse) {
    //         for (var y = 170; y >= 60; y -= 6) {path.push({x: x, y: y});
    //         }
    //     } else {
    //         for (var y = 60; y <= 170; y += 6) {path.push({x: x, y: y});
    //         }
    //     }
    // }
